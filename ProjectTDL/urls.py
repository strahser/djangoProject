...
urlpatterns = [
    ...
    path("task/<int:pk>/remind/", views.task_reminder_add, name='task_reminder_add'),
    path("task/<int:pk>/comment/", views.task_comment_add, name='task_comment_add'),
    path("task/<int:pk>/attach/", views.task_attachment_add, name='task_attachment_add'),
    path("task/<int:pk>/email/candidates/", views.task_email_candidates, name='task_email_candidates'),
    path("task/<int:pk>/email/attach/", views.task_email_attach, name='task_email_attach'),
    path("task/<int:pk>/email/<int:email_id>/detach/", views.task_email_detach, name='task_email_detach'),
