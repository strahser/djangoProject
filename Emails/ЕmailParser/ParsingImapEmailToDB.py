...
from Emails.ЕmailParser.EmailImapAttachedEmailType import EmailImapAttachedEmailType
from Emails.ЕmailParser.EmailImapAttachedGenericType import EmailImapAttachedGenericType
